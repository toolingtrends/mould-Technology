...
export default async function BuildPage() {
  ...
  description="Advanced manufacturing techniques and best practices for tooling and production environments."
  sectionTitle="Latest Advanced Manufacturing Articles"
/>
