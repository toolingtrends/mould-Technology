...
export default async function MaintainanceOperationsPage() {
  ...
  const buildPosts = posts.filter(
    (p) => slugOf(p) === "maintenance&operations"
  )
  ...
  description="Strategies and best practices for maintaining and operating tooling equipment effectively."
  sectionTitle="Latest Maintenance & Operations Articles"
/>
